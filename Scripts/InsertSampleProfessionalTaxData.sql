...
-- Insert sample PF Configuration
DELETE FROM PFConfiguration
INSERT INTO PFConfiguration (Employee_Rate, Employer_Rate, Employer_EPS_Rate, Basic_Salary_Limit, Effective_Date, Financial_Year, CreatedBy) VALUES
(12.00, 12.00, 8.33, 15000.00, '2024-04-01', '2024-2025', 'ADMIN')

-- Insert sample ESI Configuration
DELETE FROM ESIConfiguration
INSERT INTO ESIConfiguration (Employee_Rate, Employer_Rate, Basic_Salary_Limit, Effective_Date, Financial_Year, CreatedBy) VALUES
(0.75, 3.25, 21000.00, '2024-04-01', '2024-2025', 'ADMIN')
