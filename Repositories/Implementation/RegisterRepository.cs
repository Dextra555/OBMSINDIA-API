...

{
...

    {
...

        {
            ...
            return _dbContext.Obmsusers.Where(u=>!u.IsDeleted).ToList();
...

        {
            ...
            return _dbContext.BankLists.ToList();
...

        {
            ...
            var bankLists = await(from obms in _dbContext.OBMSBanks
        ...
        public async Task<bool> AddScreen(string screenName, string category)
        {
            try
            {
                // Check if screen already exists
                var existingScreen = await _dbContext.ScreenLists
                    .FirstOrDefaultAsync(s => s.ScreenName == screenName);
                ...
                _dbContext.ScreenLists.Add(newScreen);
                await _dbContext.SaveChangesAsync();
