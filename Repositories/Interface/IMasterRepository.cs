...

{
...

    {
        ...
        Task<(bool Success, BranchMaster? Branch, string Message)> DeleteBranchMasterByCode(string code);

        Task<List<ClientMaster>> GetClientMsterList(string clientCode, string status);
        ...
        Task<List<ClientMaster>> GetClientMsterListByComplianceStatus(string branchCode, string status);

        Task<object> GetComplianceSummary(string branchCode);
