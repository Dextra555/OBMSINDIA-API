...
namespace OBMS.WebAPI.Repositories.Interface
{
    public interface IFinanceRepository
    {
        ...
        Task<object> GetPaymentListByCategory(string categoryId, DateTime startDate, DateTime endDate);
        Task<decimal> GetBranchPaymentsTotalAmountByCategory(string categoryId, DateTime startDate, DateTime endDate);
    }
}
